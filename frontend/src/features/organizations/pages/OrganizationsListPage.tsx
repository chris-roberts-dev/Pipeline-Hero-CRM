...
function readFilters(searchParams: URLSearchParams): OrganizationFilters {
...
export function OrganizationsListPage() {
  ...
  const organizationsQuery = useOrganizationsQuery(filters);
  ...
  function updateFilters(nextFilters: Partial<OrganizationFilters>) {
  ...
  function handleSearchSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    updateFilters({
      ...
      status: (String(formData.get('status') ?? 'all') as OrganizationFilters['status']) || 'all',
      ordering:
        (String(formData.get('ordering') ?? '-updated_at') as OrganizationFilters['ordering']) ||
        '-updated_at',
    });
  }
  ...
  const errorPayload = organizationsQuery.error instanceof ApiError ? organizationsQuery.error.payload : null;
  ...
  return (
    <div className="page-stack">
      <PageHeader
        ...
        actions={<Button disabled={!capabilities.includes('clients.create')}>New organization</Button>}
      />
      ...
      <Card>
        <form className="organizations-filters" onSubmit={handleSearchSubmit}>
          <label>
          ...
          <div className="organizations-filters__actions">
      ...
      {organizationsQuery.isError ? (
        <Card>
          ...
          <p>
            This state is also intentionally mockable. Use the <strong>Organizations error</strong> scenario to design the page before the real Django endpoint exists.
          </p>
        ...
        <>
          ...
          <div className="organizations-pagination">
            ...
            <div className="organizations-pagination__actions">
              <Button
                type="button"
                variant="secondary"
